...
console.log(calcularMedia([15, 25, 80, 100]));
...
function areaDoTriangulo(base, altura) {
    return +((base * altura) / 2).toFixed(2);    // o operador + é usado para converter a string resultante de toFixed() de volta para um número
}
...
console.log(menorNumero([15, 25, 80, 100]));
...
function funcaoDaSorte(numero) {
    ...
    if (numero >= 1 && numero <= 10) {
        if (numero === numeroSorteado) {
            ...
            return `Que pena! O número sorteado foi o ${numeroSorteado} e o número informado foi o ${numero}`;
        };
    } else {
